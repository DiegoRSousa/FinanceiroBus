...
{
    partial class FormReportContaAReceber
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "DataSetContaAReceber";
            reportDataSource1.Value = this.ContaAReceberBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "FinanceiroBus.View.Report.ReportContaAReceber.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(856, 415);
            this.reportViewer1.TabIndex = 0;
            // 
            // ContaAReceberBindingSource
            // 
            this.ContaAReceberBindingSource.DataSource = typeof(FinanceiroBus.Model.Report.ContaAReceber);
            // 
            // FormContaAReceber
            // 
